...
std::tuple<Eigen::VectorXd, std::vector<double>>  Static2D()
{
    ...
    Eigen::VectorXd phi_tot = solver.solve(b_vec);

    return std::make_tuple(phi_tot, eps_r);
}
