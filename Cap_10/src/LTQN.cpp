...
std::vector<Vec2> LTQN(const std::vector<double>& lambda, const std::vector<Vec2>& nabla_lambda) {
    ...
    // Face functions
    LTQN_functions[6][0] = lambda[1]*lambda[2]*nabla_lambda[0][0] + lambda[0]*lambda[2]*nabla_lambda[1][0]
                         - 2*lambda[0]*lambda[1]*nabla_lambda[2][0];
    LTQN_functions[6][1] = lambda[1]*lambda[2]*nabla_lambda[0][1] + lambda[0]*lambda[2]*nabla_lambda[1][1]
                         - 2*lambda[0]*lambda[1]*nabla_lambda[2][1];

    LTQN_functions[7][0] = lambda[2]*lambda[0]*nabla_lambda[1][0] + lambda[1]*lambda[0]*nabla_lambda[2][0]
                         - 2*lambda[1]*lambda[2]*nabla_lambda[0][0];
    LTQN_functions[7][1] = lambda[2]*lambda[0]*nabla_lambda[1][1] + lambda[1]*lambda[0]*nabla_lambda[2][1]
                         - 2*lambda[1]*lambda[2]*nabla_lambda[0][1];
