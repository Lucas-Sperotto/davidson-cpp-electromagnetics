#include "../include/cavity_modes3D.hpp"
...
// Translation of cavity_modes3D.m.
// Note: the original MATLAB file is marked incomplete and currently only
// enumerates the TE-family branch with pp != 0.
