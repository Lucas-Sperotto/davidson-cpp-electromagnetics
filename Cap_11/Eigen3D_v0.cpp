...
{
    std::cout
        << "Uso: ./build/Eigen3D_v0 [opcoes]\n"
        << "  --symmetry 0|1   usa os planos de simetria magnetica (padrao 0)\n"
        ...
        << "  --nx N           numero de bricks em x (padrao 8)\n"
        << "  --ny N           numero de bricks em y (padrao 4)\n"
        << "  --nz N           numero de bricks em z (padrao 6)\n"
...
int main(int argc, char **argv)
{
    ...
    {
        std::cerr << "Falha ao resolver o autoproblema do Eigen3D_v0.\n";
        return 1;
    }
    ...
    std::ofstream modes(out_dir / "eigdata3D_v0_modes.csv");
    ...
    std::ofstream summary(out_dir / "eigen3d_v0_summary.csv");
    summary << "key,value\n";
    ...
    std::cout << "Arquivos gerados: eigdata3D_v0_modes.csv e eigen3d_v0_summary.csv\n";
    return 0;
}
